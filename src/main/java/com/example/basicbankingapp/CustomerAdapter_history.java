...
public class CustomerAdapter_history extends RecyclerView.Adapter<ViewHolder> {
    ...
    com.example.basicbankingapp.history_list HistoryList;
    List<Model> modelList;
    Context context;

    TextView mTransc_status;

    public CustomerAdapter_history(com.example.basicbankingapp.history_list historyList, List<Model> modelList) {
