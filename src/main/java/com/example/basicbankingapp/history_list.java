...
public class history_list extends AppCompatActivity {
    ...
    private void showData() {
        ...
        Cursor cursor = new com.example.basicbankingapp.DatabaseHelper(this).readtransferdata();
        ...
        adapter = new CustomerAdapter_history(com.example.basicbankingapp.history_list.this, modelList_historylist);
